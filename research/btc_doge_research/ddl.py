"""Idempotent Phase-1 DDL. Every object is confined to btc_doge_research."""
...
CREATE TABLE IF NOT EXISTS {TARGET_DATABASE}.research_ingestion_batches
(
    batch_id String,
...
CREATE TABLE IF NOT EXISTS {TARGET_DATABASE}.research_source_files
(
...
CREATE TABLE IF NOT EXISTS {TARGET_DATABASE}.research_liquidation_events
(
    symbol LowCardinality(String),
    event_time DateTime64(3, 'UTC'),
...
CREATE TABLE IF NOT EXISTS {TARGET_DATABASE}.research_orderbook_ob200_snapshots
(
    symbol LowCardinality(String),
    event_time DateTime64(3, 'UTC'),
    receive_time Nullable(DateTime64(6, 'UTC')),
...
CREATE TABLE IF NOT EXISTS {TARGET_DATABASE}.research_orderbook_levels_pilot
(
    symbol LowCardinality(String),
    event_key FixedString(64),
    event_time DateTime64(3, 'UTC'),
...
CREATE TABLE IF NOT EXISTS {TARGET_DATABASE}.research_orderbook_1s
(
    symbol LowCardinality(String),
...
CREATE TABLE IF NOT EXISTS {TARGET_DATABASE}.research_market_1s
(
    symbol LowCardinality(String),
    bucket_time DateTime64(0, 'UTC'),
...
CREATE TABLE IF NOT EXISTS {TARGET_DATABASE}.research_market_1m
(
    symbol LowCardinality(String),
    bucket_time DateTime64(0, 'UTC'),
...
CREATE TABLE IF NOT EXISTS {TARGET_DATABASE}.research_coverage
(
...
CREATE TABLE IF NOT EXISTS {TARGET_DATABASE}.research_pipeline_state
(
    state_key String,
