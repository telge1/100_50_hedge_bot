"""Atomic case status / checkpoint helpers for expansion batch."""
...
def mechanical_complete_valid(repo_root: Path, case_id: str) -> tuple[bool, str | None]:
    """True only if status MECHANICAL_COMPLETE and payload SHA matches file."""
    st = read_case_status(repo_root, case_id)
    ...
    from orderbook_analyse.liquidity_pool_entry_contract_batch_v1.hashes import payload_sha256
